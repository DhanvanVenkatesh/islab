public class AES {
	...
	public static void main(String[] args){
		...
		for(int i=4;i<44;i++){ 
			if(i%4==0){
				temp=g(word,i-1,count); temp=xor(getCol(word,i-4),temp); fill(word,temp,i,i+1);
				count++;
			}
			else{
				temp=xor(getCol(word,i-4),getCol(word,i-1)); fill(word,temp,i,i+1);
			} 
			if(i%4==3){
				System.out.println("ROUND "+((i/4))); print(word);
			}
		}
	}
}