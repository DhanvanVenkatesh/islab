...
public class KeyGenerator extends JFrame {
	...
	public KeyGenerator() {
		...
		JLabel lblTemperatureConversion = new JLabel("Key Generator");
		...
		btnC.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e1) {
				...
				else 
				{
					...
					BigInteger p,q,e,d;
					String str;
			        p = new BigInteger(c.getText());
			        q = new BigInteger(f.getText());
			        BigInteger n = p.multiply(q);
			        BigInteger eulerPi = (p.subtract(r)).multiply(q.subtract(r));
			        while(true){
			            e = new BigInteger(k.getText());
			            if (extEuclid(e,eulerPi,1).equals(r)){
			                d = extEuclid(e,eulerPi,0);
			                str = " Public:{"+ e +","+ n +"}" + "  Private: {"+ d +","+ n +"}";		                break;
			            }
			            else{
			                str = "Try with another number";
			            }
			        }
					tfOut.setText(str);
				}
